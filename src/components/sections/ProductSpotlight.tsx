...
const products = [
  ...
  },
  {
    ...
    tagline: "Packaging dengan ukuran custom",
    desc: "Semua produk SAPK dapat di custom. Solusi bagi kamu yang punya preferensi sendiri di pasar modern. Tersedia dalam berbagai ketebalan, gramasi, dan warna.",
    specs: ["Flexible Request", "Any Color", "Any Size"],
    industries: "Retail  ·  F&B  ·  E-commerce  ·  Gift",
    props: [
  ...
  },
  {
    abbr: "Sablon",
    name: "Sablon Premium",
    tagline: "Jasa Sablon Premiun di seluruh produk SAPK",
    desc: "Tersedia untuk seluruh produk SAPK. Solusi kustomisasi untuk menghidupkan kreasi produk. Tersedia dalam berbagai warna, jenis, dan ukuran.",
    specs: ["Flexible Request", "Any color", "Custom Print"],
    industries: "Retail  ·  F&B  ·  E-commerce  ·  Gift",
    props: [
      { label: "Kekuatan",      value: 100 },
      { label: "Fleksibilitas", value: 100 },
      { label: "Tahan Panas",   value: 100 },
      { label: "Food Safety",   value: 100 },
    ],
  },
];
