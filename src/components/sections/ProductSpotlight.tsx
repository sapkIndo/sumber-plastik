...
const products = [
  ...
  },
  {
    abbr: "PE",
    name: "PE",
    tagline: "Sendok, garpu & peralatan makan sekali pakai",
    desc: "Polyethylene untuk kebutuhan peralatan makan plastik sekali pakai — sendok, garpu, pisau, dan sedotan. Ringan, food-safe, dan ekonomis untuk catering, restoran, food stall, hingga event skala besar. Tersedia juga dalam varian kantong dan film.",
    specs: ["Food Grade", "Recyclable", "Bebas BPA"],
    industries: "F&B  ·  Catering  ·  Restoran  ·  Event",
    props: [
      { label: "Food Safety",   value: 90 },
      { label: "Kekuatan",      value: 72 },
      { label: "Fleksibilitas", value: 78 },
      { label: "Tahan Panas",   value: 45 },
    ],
  },
  {
    abbr: "PS",
